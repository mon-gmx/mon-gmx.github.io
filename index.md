...
Kind of, try: `dig +trace -x google.com` and you see it. Normally you don't want to mix the `trace` and `nssearch` flags to avoid confusing the tool and if you happen to have your own Bind9 DNS you are going to get a more thorough view. Cherry on top? Add `strace` and see the syscalls by yourself.

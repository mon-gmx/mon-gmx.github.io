...
Going back to point one, I could never make up my mind how with a person writing code for a living could make close to a million a year while the people feeding the same useless monkey can barely make ends meet when producing their organic overpriced kale. I get it that this is more of a markets driven behavior, but it has been destructive, even to the companies that started this and that now try to "free up" resources.

...
To anyone looking at my profile or my resume, I can divide my experience in two groups: long term commitment, and short stints a.k.a. fuck ups. The first group I can list them clearly, those are my proudest moments, the second one, you would be scratching your head asking _where are those?_ well, I barely speak about it. I could give insight on the fuck ups trying to justify why they didn't work for me, but I must own my mistakes and state this was all on me: **Fueled by the desperation of getting employed, I didn't spend enough time trying to figure out whether the place was right for me and if I would fit in**. Culture matters and it matters a lot, not fitting is a troubling situation where you better hope you don't find that out while stranded in New York City asking yourself, what now? (true story). 

Choosing to leave is never a thing that happens in an instant, it is not an easy choice to do, it requires thinking about consequences and in most cases, these play against the person leaving; personally, gathering the courage is a different thing, is something that has happened in a snap, and with a clear understanding that the coming days would become a struggle, I still have vouched for my own peace of mind and taken the painful step of saying "_that's enough_".
